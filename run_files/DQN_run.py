...
checkpoint_callback = CheckpointCallback(save_freq=100000, save_path='../baselines/logs/',
...
model.save("deepq_GymCombatEnv_CnnPolicy_3000000_Berlin")
model = DQN.load("deepq_GymCombatEnv_CnnPolicy_3000000_Berlin")
